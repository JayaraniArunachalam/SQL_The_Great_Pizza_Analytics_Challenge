# 🍕 The Great Pizza Analytics Challenge — Question List

This document contains all the questions from the IDC Pizza SQL Challenge, organized by phase.  
Solutions are provided separately in CSV files.

---

## 📌 Phase 1: Foundation & Inspection

1. Install `IDC_Pizza.dump` as `IDC_Pizza` server/database.
